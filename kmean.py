...
COLORS = [RED,GREEN,BULE,YELLOW,PURPLE,SKY,ORANGE,GRAPE,GRASS]
...
while running:
	...
	#Draw mouse possition when mouse is in panel
	...
	for event in pygame.event.get():
		...
		if event.type == pygame.MOUSEBUTTONDOWN:
			...
			if 850 < mouse_x < 1000 and 150 < mouse_y < 200:
				...
				# assgin points to closet clusters
				for p in points:
